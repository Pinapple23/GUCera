create DATABASE GUCeraDatabase
...
go  
Exec studentRegister'mark' , 'mark' , 'aa' , 'adadadadad' , 1 , 'adadad'
go
----------------------------------------------------
...
exec InstructorgradeAssignmentOfAStudent 24 , 1 , 2 , 6 , 'exam' , 52
go
...
GO
exec InstructorIssueCertificateToStudent 2 , 1 , 24 , '2/2/2020'
go
-----------------------------------------------------------------------
--Student
